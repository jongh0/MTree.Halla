BEGIN_FUNCTION_MAP
	.Func,현물계좌예수금 주문가능금액 총평가조회,CSPAQ02200,SERVICE=CSPAQ02200,headtype=B,CREATOR=김기종,CREDATE=2012/03/14 13:40:43;
	BEGIN_DATA_MAP
	CSPAQ02200InBlock1,In(*EMPTY*),input;
	begin
	...
	CSPAQ02200OutBlock1,In(*EMPTY*),output;
	begin
		레코드갯수, RecCnt, RecCnt, long, 5
		관리지점번호, MgmtBrnNo, MgmtBrnNo, char, 3;
		계좌번호, AcntNo, AcntNo, char, 20;
	...
	CSPAQ02200OutBlock2,Out(*EMPTY*),output;
	begin
		레코드갯수, RecCnt, RecCnt, long, 5
