BEGIN_FUNCTION_MAP
	.Func,BEP단가조회,CSPAQ02300,SERVICE=CSPAQ02300,headtype=B,CREATOR=이상은,CREDATE=2011/11/15 14:05:42;
	BEGIN_DATA_MAP
	CSPAQ02300InBlock1,In(*EMPTY*),input;
	begin
	...
	CSPAQ02300OutBlock1,In(*EMPTY*),output;
	begin
		레코드갯수, RecCnt, RecCnt, long, 5
		계좌번호, AcntNo, AcntNo, char, 20;
		비밀번호, Pwd, Pwd, char, 8;
	...
	CSPAQ02300OutBlock2,Out(*EMPTY*),output;
	begin
		레코드갯수, RecCnt, RecCnt, long, 5
	...
	CSPAQ02300OutBlock3,ST_OUT(*EMPTY*),output,occurs;
	begin
