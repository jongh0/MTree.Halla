    ...
    public partial class EbestPublisher
    {
        ...
        private void CircuitBreakReceived(XARealClass subscribingObj)
        {
            try
            {
                ...
                logger.Info($"CircuitBreak debugging, type: {circuitBreakType}, time: {time}, svi_recprice: {svi_recprice}, dvi_recprice: {dvi_recprice}, InvokePrice: {circuitBreak.InvokePrice}");  
#endif
