BEGIN_FUNCTION_MAP
	.Func,현물계좌주문체결내역조회,CSPAQ03700,ENCRYPT,SERVICE=CSPAQ03700,headtype=B,CREATOR=이상은,CREDATE=2012/03/14 13:45:26;
	BEGIN_DATA_MAP
	CSPAQ03700InBlock1,In(*EMPTY*),input;
	begin
	...
	CSPAQ03700OutBlock1,In(*EMPTY*),output;
	begin
		레코드갯수, RecCnt, RecCnt, long, 5
		계좌번호, AcntNo, AcntNo, char, 20;
		입력비밀번호, InptPwd, InptPwd, char, 8;
	...
	CSPAQ03700OutBlock2,OUT1(*EMPTY*),output;
	begin
		레코드갯수, RecCnt, RecCnt, long, 5
	...
	CSPAQ03700OutBlock3,OUT(*EMPTY*),output,occurs;
	begin
		주문일, OrdDt, OrdDt, char, 8;
